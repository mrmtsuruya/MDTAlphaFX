  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Market News — MDTAlphaFX" },
      {
        ...
        content: "Live macro news and geopolitical events impacting FX.",
      },
    ],
  }),
  component: News,
...
const MOCK = [
  ...
  {
    t: "EUR",
    title: "ECB Lagarde: inflation risks tilted to upside",
    impact: "medium",
    time: "34m ago",
  },
  {
    t: "JPY",
    title: "BoJ intervention chatter as USDJPY tests 156.5",
    impact: "high",
    time: "1h ago",
  },
  {
    t: "GBP",
    title: "UK CPI prints hotter than expected at 3.4%",
    impact: "medium",
    time: "2h ago",
  },
  ...
  {
    t: "GEO",
    title: "Escalation risk in Middle East drives risk-off flows",
    impact: "high",
    time: "6h ago",
  },
];
    ...
    <div className="p-6 space-y-4 animate-fade-up">
      <header>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Live macro news that feeds the signal validity engine.
        </p>
      </header>
          ...
          <div key={i} className="p-4 flex items-start gap-3 hover:bg-cyber-surface-2">
            <span
              className={`font-mono text-[10px] px-2 py-1 rounded ${
                n.impact === "high"
                  ? "bg-neon-short/20 text-neon-short"
                  : n.impact === "medium"
      ...
      <p className="text-[10px] font-mono text-muted-foreground">
        // Live news wire integration is stubbed. Wire a provider (Finnhub, TradingEconomics, or
        ForexFactory) via a scheduled server route to populate real events.
      </p>
    </div>
  );
}
