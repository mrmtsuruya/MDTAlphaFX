...
The saved replay passes the independent mechanical audit across **27,070 H1 rows**, **1,969 observed transitions**, and **1,973 effective-regime segments**.

All **83 one-bar segments** were inspected. **76** are deterministic A→B→A whipsaw candidates; none is mechanically impossible. This is observable label churn, not proof that the underlying feature classification was false.
...
- Replay: `C:/Users/mrmts/Downloads/MDTAlphaFX Automation/docs/stage1-gate/regime_replay.json`
- SHA-256: `be32c7e6ab2cb5d8097b34585cf247d6affb95cf4238169e000d3042f5c1a175`
- Replay generated: `2026-07-27T12:07:37.272738+00:00`
- Account label: `DEMO 1100509764 @ JustMarkets-Demo2`
- Timeframe: `H1`
- Symbols: 4
- Replay config `ffc670e8179c`; audit config `ffc670e8179c`; whole-config match: `True`
...
|---|---:|---:|---:|---:|---:|---:|
| BTCUSD | 8,760 | 626 | 625 | 28 | 1 | 2 h |
| EURUSD | 6,204 | 501 | 500 | 25 | 55 | 50 h |
| GBPUSD | 6,204 | 455 | 454 | 20 | 55 | 50 h |
| XAUUSD | 5,902 | 391 | 390 | 10 | 257 | 74 h |
...
|---|---:|---:|
| All one-bar segments | 83 | 100.0% |
| A→B→A round-trip candidates | 76 | 91.6% |
| Non-round-trip one-bar segments | 7 | 8.4% |
| Price triage: supportive | 17 | 20.5% |
| Price triage: mixed | 49 | 59.0% |
| Price triage: contradictory | 17 | 20.5% |
...
The replay contains **1,890 sustained segments**, of which **1,886** have their entry boundary inside the saved window. All observed entries satisfy the independent hysteresis rule.

| Price triage | Segments | Share of sustained segments |
|---|---:|---:|
| SUPPORTIVE | 465 | 24.6% |
| MIXED | 409 | 21.6% |
| CONTRADICTORY | 109 | 5.8% |
| NOT_SCORED | 903 | 47.8% |
| UNAVAILABLE | 4 | 0.2% |
...
1. **Medium — one-bar effective churn:** 76 of 83 one-bar segments are A→B→A round trips. They are spec-conformant but briefly swap the active cluster map after confirmation, so they should remain an explicit Stage 1 operating diagnostic.
...
- Raw classification: **27,070/27,070 verified**.
- Hysteresis transitions: **1,969/1,969 verified**.
- One-bar entries: **83/83 mechanically supported**.
- Sustained observed entries: **1,886/1,886 mechanically supported**.
